          ...
          <div class="w-490 h-496 flex-shrink-0 bg-white p-8 rounded-2xl">
            <form>
              <div class="mb-6 relative">
                <label for="email" class="block text-gray-700 font-medium mt-3">Email</label>
              ...
              <div class="flex items-center justify-end mb-4">
                <div class="text-sm">
                  <a href="#" class="text-blue-500 hover:text-blue-600">Forgot my password</a>
                </div>
              </div>
              <div class="flex items-center justify-center mt-16">
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-full w-full" style="width: 430px; height: 55px; flex-shrink: 0; border-radius: 50px; background: #4743FB;">Sign In</button>
              </div>
            </form>
            <div class="flex items-center justify-center mt-10">
              <button type="submit" class="bg-white hover:bg-blue-600 text-blue-500 font-semibold py-2 px-4 rounded-full w-full" style="width: 430px; height: 55px; flex-shrink: 0; border-radius: 50px; border: 1px solid #D8D8E4;">Create An Account</button>
            </div>
          </div>
        </div>
  </div>
